...
public final class FileSearchUtil {
	...
	public FileSearchUtil(String path) {
		file = new File(path);
		this.regex = ".*";
	}

	public FileSearchUtil(File file) {
		this.file = file;
		this.regex = ".*";
	}

	public FileSearchUtil(String path, String regex) {
		file = new File(path);
		this.regex = regex;
	}

	public FileSearchUtil(File file, String regex) {
		this.file = file;
		this.regex = regex;
	}
