...
public class IPUtil {
     ...
     * @return
     */
    public static InetAddress catchServerIP(String hostname) {
    	//String hostname="m.cpstest.411game.com"
		InetAddress ServerIP = null;
		try {
			ServerIP = InetAddress.getByName(hostname); // 取得m.cpstest.411game.com的IP地址
    ...
    public static void main(String[] args) {
    	InetAddress netAddress=IPUtil.catchServerIP("www.baidu.com");
